        ...
        <template v-if="navigationType === '1' && headerTemplateReceived">
            ...
            <ul class="common-header-linkList">
                ...
                <span
                        ...
                        :class="(langHover === 'broker') ? 'h-4-bg x-3-cl' : ''"
                ...
                <span
                        ...
                        :class="(langHover === 'minings') ? 'h-4-bg x-3-cl' : ''"
                ...
                <span
                        ...
                        :class="(langHover === 'innov_tit') ? 'h-4-bg x-3-cl' : ''"
                ...
                <span
                        ...
                        :class="(langHover === 'manageFinances') ? 'h-4-bg x-3-cl' : ''"
                  ...
                  {{$t('manageFinances.manage_finances')}}
                            ...
                            <!-- <li v-if="appDownload.app_page_url" class="x-2-cl g-3-cl-h">
                              <span
                                ...
                                :class="(langHover === 'appDownload') ? 'h-4-bg x-3-cl' : ''"
                ...
                <span
                        ...
                        :class="(langHover === '/questions/init') ? 'h-4-bg x-3-cl' : ''"
                ...
                <li
                        ...
                        @click="btnHref(item.link, false, { trades: true, id: item.activeId })">
                    {{ item.title }}
                </li>
                <!--  自定义导航 -->
