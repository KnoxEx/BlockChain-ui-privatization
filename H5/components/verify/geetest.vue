...
<template>
  <section class="common-geetest"
    ...
    <div class="common-geetest-baseStance a-2-bd"
      ...
      <div v-if="!isReady" class="common-geetest-loading"><c-h-loading size="20" /></div>
      <div id="captchaBox" class="a-5-bg" ref="captchaBox"></div>
      <!-- 选中时横线 -->
      <span class="common-geetest-activeLine"
        :class="activeLineClass"
        :style="activeLineStyle"></span>
    </div>
    <!-- 错误文案占位 24px -->
