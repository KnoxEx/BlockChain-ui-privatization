  ...
  methods: {
    ...
    submit() {
      ...
      if (this.nowType === 'phone') {
        this.axios({
          // url: 'v4/user/reg_mobile',
          url: '/user/reg_mobile_chk_info',
          params: {
            countryCode: this.countryKeyCode, // 国家编号
            mobileNumber: this.userValue, // 手机号
            // smsAuthCode: this.checkValue, // 验证码
        ...
        this.axios({
          // url: 'v4/user/reg_email',
          url: '/user/reg_email_chk_info',
          params: {
